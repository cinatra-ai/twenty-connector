...
// runtime (the src/dev-setup.ts devSetup hook) AND the plain-node bootstrap proof
// (scripts/twenty-bootstrap/twenty-bootstrap-proof.mjs in THIS repo) — single
// source of truth for the brittle Twenty CLI command + JWT shape, per the
// convergence decision. Relocated from core src/lib/twenty-keygen.mjs with
// cinatra-ai/cinatra#976 (epic #978 W-D).
